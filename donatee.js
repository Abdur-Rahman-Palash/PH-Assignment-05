...
document.getElementById('success-modal').addEventListener('click', function(){
    ...
    p.innerText = `96500 Taka is Donated for famine-2024 at Feni, Bangladesh `;
    const transactionContainer =document.getElementById('history-form');
    transactionContainer.appendChild(p);

})
document.getElementById('success-modal1').addEventListener('click', function(){
...
document.getElementById('success-modal2').addEventListener('click', function(){
